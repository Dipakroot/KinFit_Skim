...
class SkimAna : public TSelector {
  ...
  // TH2F *SFb_hist_jerDown = 0x0, *SFc_hist_jerDown = 0x0, *SFl_hist_jerDown = 0x0;
   ...
   bool doubleTau_old = false; 
   bool Ele_Muon_veto =false;
	// MET
   ...
   bool    FillLeptonVetoControlHists();
...
void SkimAna::Init(TTree *tree)
{
  ...
  //added
  tree->SetBranchStatus("Electron_mvaFall17V2Iso_WPL",1);
  tree->SetBranchAddress("Electron_mvaFall17V2Iso_WPL", &(event->eleIDmvaIsoLoose_));
