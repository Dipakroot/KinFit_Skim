...
condorOutDir1=/eos/user/d/dmaity/condor_job/LQAnalysis/Background/TTbarPowheg_Hadronic
...
if [ -z ${_CONDOR_SCRATCH_DIR} ] ; then
    ...
    xrdcp -f ${sample}_bjet_*.root root://eosuser.cern.ch/${condorOutDir}/${year}
    xrdcp -f ${sample}_tree_*.root root://eosuser.cern.ch/${condorOutDir}/${year}
