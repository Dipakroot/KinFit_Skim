...
public:
	...
	std::vector<int> Taus;
	std::vector<int> Taus_test1; 
	std::vector<int> Taus_test2;

	std::vector<int> Jets;
	std::vector<int> bJets;
        std::vector<int> FwdJets;
	std::vector<int> Jets_test1;	
	std::vector<int> Jets_test2;
	std::vector<int> Jets_test3;	
	...
	void filter_jets(EventTree* tr, int tauId_1, int tauId_2);
	//void filter_jets();
